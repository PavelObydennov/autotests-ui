...
def initialize_playwright_page(playwright:Playwright, test_name: str, storage_state: str | None = None)-> Page:
    ...
    allure.attach.file(f'./tracing/{test_name}.zip', name='trace',extension='zip') # файл трейсинга
    allure.attach.file(page.video.path(), name='video', attachment_type=allure.attachment_type.WEBM) # Видео