...
class LoginPage(BasePage):
    def __init__(self,page: Page):
        ...
        # self.login_button = page.get_by_test_id('login-page-login-button') До page factory
        self.login_button = Button(page,'login-page-login-button', 'Login')

        # self.registration_link = page.get_by_test_id('login-page-registration-link') До page factory
        self.registration_link = Link(page, 'login-page-registration-link', 'Registration')

        # self.wrong_email_or_password_alert = page.get_by_test_id('login-page-wrong-email-or-password-alert') До page factory
